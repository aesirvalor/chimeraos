...
mount -t btrfs -o loop,noatime,compress-force=zstd:15 ${BUILD_IMG} ${MOUNT_PATH}
...
useradd -m ${USERNAME} -G autologin,wheel,libvirt,audio,video,realtime,kvm,adm,log,rfkill,uucp,plugdev
